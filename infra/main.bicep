...
module aoai 'aoai/openAi.module.bicep' = {
  name: 'aoai'
  scope: rg
  params: {
    location: location
...
module vectorSearch_roles 'vectorSearch-roles/vectorSearch-roles.module.bicep' = {
  name: 'vectorSearch-roles'
  scope: rg
  params: {
    location: location
    principalId: resources.outputs.MANAGED_IDENTITY_PRINCIPAL_ID
    principalType: 'ServicePrincipal'
    vectorsearch_outputs_name: vectorSearch.outputs.name
  }
}
